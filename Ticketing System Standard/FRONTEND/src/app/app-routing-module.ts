...
import { PublicTicketActionComponent } from './public/ticket-action/ticket-action';
...
export const routes: Routes = [
  ...
  // ADDED: Public status transition links via secure emails
  { path: 'public/ticket-action', component: PublicTicketActionComponent },
